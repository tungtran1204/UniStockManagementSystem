...
// Hàm xử lý khi nhấn nút "Tạo loại nguyên liệu"
...
<Dialog open={true} handler={onClose} size="md" className="px-4 py-2">
    ...
    <DialogBody className="space-y-4 pb-6 pt-6">
        ...
        <div>
            ...
            <TextField fullWidth size="small" hiddenLabel placeholder="Tên loại nguyên liệu" color="success"
        ...
        <div>
            ...
            <TextField fullWidth size="small" hiddenLabel placeholder="Mô tả" variant="outlined" multiline rows={3}
                color="success" value={formData.description} onChange={(e)=> setFormData({ ...formData, description:
                e.target.value })}
                />
        </div>
    </DialogBody>
