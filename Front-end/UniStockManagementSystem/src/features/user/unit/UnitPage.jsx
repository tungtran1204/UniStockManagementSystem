...
const UnitPage = () => {
            ...
            renderCell: (params) => (
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  disabled={!currentUser?.permissions?.includes("toggleStatusUnit")} // Vô hiệu hóa nếu không có quyền
                  onChange={() => {
          ...
          },
          {
            ...
            renderCell: (params) => (
              <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                {currentUser?.permissions?.includes("updateUnit") && (
                  <Tooltip content="Chỉnh sửa">
                    <IconButton
                      size="small"
                      onClick={() => {
                        const unitWithCorrectId = {
                          ...params.row,
                          unitId: params.row.id
                        };
                        setEditUnit(unitWithCorrectId);
  ...
  showImport={false}
  showExport={false}
  showAdd={currentUser && currentUser.permissions.includes("createUnit")}
/>
