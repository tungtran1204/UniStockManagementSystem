...
const PERMISSION_HIERARCHY = {
  ...
  viewSaleOrder: ["getFilteredOrders", "getOrderById", "getMaterialsByProduct"],
  manageSaleOrder: [
    "getFilteredOrders",
    "getOrderById",
    "getMaterialsByProduct",
  ...
  viewReceiptNote: ["getAllGoodReceipts", "getGoodReceiptById", "getIssueNoteById"],
  manageReceiptNote: [
    "getAllGoodReceipts",
    "getGoodReceiptById",
    "getIssueNoteById",
  ...
  viewIssueNote: ["getAllIssueNotes", "getIssueNoteById", "getOrderById", "getMaterialsByProduct"],
  manageIssueNote: [
    "getAllIssueNotes",
    "getIssueNoteById",
    "getOrderById",
