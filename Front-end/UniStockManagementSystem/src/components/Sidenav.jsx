...
export function Sidenav({routes }) {
  ...
  return (
    <aside
      className={`fixed mt-[65px] inset-y-0 left-0 z-50 h-screen w-[240px] bg-white shadow-none border-r border-gray-200 transition-transform duration-300 ${openSidenav ? "translate-x-0" : "-translate-x-full"
        }`}
    >
      {/* Menu */}
      <nav className="p-4">
