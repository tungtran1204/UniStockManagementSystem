...
//
//    @Autowired
//    private IssueNoteDetailViewMapper issueNoteDetailViewMapper;
//
...
//
//        // Gán danh sách detail đã map view (IssueNoteDetailViewDTO)
//        List<IssueNoteDetailViewDTO> viewDetails = note.getDetails().stream()
//                .map(issueNoteDetailViewMapper::toDTO)
//                .collect(Collectors.toList());
//        // Ép kiểu tạm (nếu IssueNoteDTO.details đang định nghĩa kiểu List<IssueNoteDetailDTO>)
